...
function validate () {
    ...
    if (isNaN(phone) || phone.length != 10) {
        ...
        // This alert message will appear if all form fields are filled correctly alert("Form submitted successfully! Thank you for contacting us");
        return true;
}
